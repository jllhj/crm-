# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-12-24 10:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_status', models.IntegerField(blank=True, choices=[(1, '在职'), (2, '无业')], default=1, null=True, verbose_name='在职状态')),
                ...
                ('source', models.SmallIntegerField(choices=[(1, 'QQ群'), (2, '内部转介绍'), (3, '官方网站'), (4, '百度推广'), (5, '360推广'), (6, '搜狗推广'), (7, '搜腾讯课堂'), (8, '广点通'), (9, '高校宣讲'), (10, '渠道代理'), (11, '51cto'), (12, '智汇推'), (13, '网盟'), (14, 'DSP'), (15, 'SEO'), (16, '其他')], default=1, verbose_name='客户来源')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '正在跟进'), (2, '已报名'), (3, '三天未跟进'), (4, '15天未成单')], default=1, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, help_text='格式:年-月-日', null=True, verbose_name='入职时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(choices=[(100, 'A+'), (90, 'A'), (85, 'B+'), (80, 'B'), (70, 'B-'), (60, 'C+'), (50, 'C'), (40, 'C-'), (0, 'D'), (-1, 'N/A'), (-100, 'COPY')], default=-1, verbose_name='本节成绩')),
        ...
        migrations.AddField(
            ...
            name='consultant',
            field=models.ForeignKey(help_text='谁签的单', on_delete=django.db.models.deletion.CASCADE, to='crm.UserInfo', verbose_name='负责老师'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='customer',
        ...
        migrations.AddField(
            model_name='customerdistrbute',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='crm.Customer', verbose_name='客户'),
        ),
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consult', to='crm.UserInfo', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customer',
            name='course',
